(function(){
  ...
  function init(){
    ...
    if(drpToggle){
      if(isElectron){
        if(drpDesc) drpDesc.textContent = 'Display what you\'re listening to in the WRLD Player on your Discord profile.';
        window.highwrld.getStatus().then(function(s){
        ...
        if(drpDesc) drpDesc.textContent = 'Display what you\'re listening to in the WRLD Player on your Discord profile. (ONLY ON THE EXE (Windows, MacOS, and Linux) NOT FOR THE WEB OR MOBILE)';
