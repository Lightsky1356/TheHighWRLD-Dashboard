        ...
        '<div class="sugg-card-top">' +
          ...
          '<div class="sugg-card-body">' +
            ...
            '<div class="sugg-card-footer">' +
              ...
              adminBtns +
            ((s.authorName && s.authorName !== 'Anonymous' && s.authorName !== '🖥️System') ? '<button class="report-flag-btn" data-report="suggestion:' + s.id + '" title="Report"><i class="fas fa-flag"></i></button>' : '') +
            '</div>' +
          '</div>' +
        '</div>' +
      '</div>';
